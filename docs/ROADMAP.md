...
| 2026-07-20 | M6 quality decision: deterministic checks remain authoritative; only portfolio-free, read-only risk and source reviewers are admitted; strict call budgets and output parsing apply; adoption requires benchmark improvement with no metric regression; all other specialists remain deferred |
